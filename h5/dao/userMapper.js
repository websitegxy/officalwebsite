var user = {
    ...
    queryAllCarousel: 'select article_tittle,product_id,img_url from bas_cms_article where program_code = "SYLB" and status = "1" order by sort_no ',
    ...
    queryProductByBranId: 'select id,goods_name,img_main from base_product where del_flag = "0" and base_classify_id = ?',
